...
df = pd.read_csv('https://raw.githubusercontent.com/datasets/covid-19/master/data/countries-aggregated.csv',
                 parse_dates=['Date'])
# countries = ['Germany', 'Belgium', 'United Kingdom', 'US']
...
popd = pd.read_csv('L:\\OneDrive\\PycharmProjects\\Plotseling\\data\\population_csv.csv')

popd = popd[popd['Year'] == 2018]

# populations = {'Netherlands': 17231624, 'Belgium': 11433256, 'United Kingdom': 67802690, 'US': 330548815}
percapita = covid.copy()

popd.set_index('Country Name')
popd = popd[['Country Name', 'Value']]

for country in list(percapita.columns):
    percapita[country] = percapita[country] / popd.loc[popd['Country Name'] == country, 'Value'] * 100000
